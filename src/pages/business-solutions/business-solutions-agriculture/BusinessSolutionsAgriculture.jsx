...
import styles from "./BusinessSolutionsAgriculture.module.scss";
import NavigationBanner from "../../../components/NavigationBanner";
import { getAllB2BIndustrials } from "../../../api/b2b.api";
import Section from "../../../components/Section";
import ArrowLink from "../../../components/ArrowLink";

const BusinessSolutionsAgriculture = ({ match }) => {
  ...
  return (
    <Layout pageTitle="Mining & Construction" withBottomPadding={false}>
      {currentPage ? (
        <>
