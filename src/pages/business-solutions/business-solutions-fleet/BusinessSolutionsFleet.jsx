...
import styles from "./BusinessSolutionsFleet.module.scss";
import NavigationBanner from "../../../components/NavigationBanner";
import { getAllB2BIndustrials } from "../../../api/b2b.api";
import Section from "../../../components/Section";
import ArrowLink from "../../../components/ArrowLink";

const BusinessSolutionsFleet = ({ match }) => {
  ...
  return (
    <Layout pageTitle="Fleet" withBottomPadding={false}>
      {currentPage ? (
        <>
          ...
          <div className={styles.main}>
            <Section section={sortedSection[0]}>
              ...
              />
              <ArrowLink
                to="/service-station-locator"
                text="Find a Service Station"
                color={sortedSection[0].background_colour === "blue" ? "white" : "#002c90"}
              />
            </Section>
