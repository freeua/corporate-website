...
import styles from "./BusinessSolutionsChemicals.module.scss";
import NavigationBanner from "../../../components/NavigationBanner";
import { getAllB2BIndustrials } from "../../../api/b2b.api";
import Section from "../../../components/Section";
import ArrowLink from "../../../components/ArrowLink";

const BusinessSolutionsChemicals = ({ match }) => {
  ...
  return (
    <Layout pageTitle="Chemicals" withBottomPadding={false}>
      {currentPage ? (
        <>
...
export default BusinessSolutionsChemicals;
